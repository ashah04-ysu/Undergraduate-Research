...
set output "recovery/plots/bafu_m35000.png"
...
plot\
	...
	'recovery/values/35000/softimp35000.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
