...
set output "recovery/plots/bafu_red_m2000.png"

set xrange [500:500+2000]
set xtics 0,25
#set log y
...
plot\
	...
	'recovery/values/2000/softimp2000.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
