...
set output "recovery/plots/bafu_red_m6000.png"

set xrange [500:500+2500]
set xtics 0,25
#set log y
...
plot\
	...
	'recovery/values/6000/softimp6000.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
