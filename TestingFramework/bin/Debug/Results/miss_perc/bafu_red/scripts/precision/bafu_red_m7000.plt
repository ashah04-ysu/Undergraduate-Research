...
set output "recovery/plots/bafu_red_m7000.png"
...
plot\
	...
	'recovery/values/7000/trmf7000.txt' index 0 using 1:2 title 'trmf' with linespoints lt 8 dt 2 lw 3 pt 9 lc rgbcolor "orange" pointsize 1.2, \
