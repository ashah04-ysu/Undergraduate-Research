...
set output "recovery/plots/drift10_red_m500.png"
...
plot\
	...
	'recovery/values/500/softimp500.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
