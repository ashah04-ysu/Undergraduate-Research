...
set output "recovery/plots/drift10_red_m400.png"
...
plot\
	...
	'recovery/values/400/softimp400.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
