...
set output "recovery/plots/electricity_m6.png"
...
plot\
	...
	'recovery/values/6/softimp6.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
