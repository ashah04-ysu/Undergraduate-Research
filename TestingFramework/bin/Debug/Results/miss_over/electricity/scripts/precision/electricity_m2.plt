...
set output "recovery/plots/electricity_m2.png"
...
plot\
	...
	'recovery/values/2/softimp2.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
