...
set output "recovery/plots/electricity_m18.png"
...
plot\
	...
	'recovery/values/18/softimp18.txt' index 0 using 1:2 title 'softimp' with linespoints lt 8 dt 2 lw 3 pt 5 lc rgbcolor "dark-violet" pointsize 1.2, \
