...
set output "recovery/plots/drift10_red_m7.png"
...
plot\
	...
	'recovery/values/7/trmf7.txt' index 0 using 1:2 title 'trmf' with linespoints lt 8 dt 2 lw 3 pt 9 lc rgbcolor "orange" pointsize 1.2, \
