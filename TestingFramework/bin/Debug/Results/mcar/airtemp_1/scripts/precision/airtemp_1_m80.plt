...
set output "recovery/plots/airtemp_1_m80.png"
...
plot\
	...
	'recovery/values/80/cdrec80_k3.txt' index 0 using 1:2 title 'cdrec\_k3' with linespoints lt 8 lw 3 pt 7 lc rgbcolor "cyan" pointsize 1.2, \
