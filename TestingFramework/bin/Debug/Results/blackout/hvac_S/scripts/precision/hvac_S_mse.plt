...
set output "error/plots/hvac_S_mse.eps"
...
plot\
	...
	'error/mse/MSE_cdrec_k1.dat' index 0 using 1:2 title 'cdrec\_k1' with linespoints lt 8 lw 3 pt 7 lc rgbcolor "cyan" pointsize 1.2, \
...
set output "error/plots/hvac_S_rmse.eps"
...
plot\
	...
	'error/rmse/RMSE_cdrec_k1.dat' index 0 using 1:2 title 'cdrec\_k1' with linespoints lt 8 lw 3 pt 7 lc rgbcolor "cyan" pointsize 1.2, \
...
set output "error/plots/hvac_S_mae.eps"
...
plot\
	...
	'error/mae/MAE_cdrec_k1.dat' index 0 using 1:2 title 'cdrec\_k1' with linespoints lt 8 lw 3 pt 7 lc rgbcolor "cyan" pointsize 1.2, \
