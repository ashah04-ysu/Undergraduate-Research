set terminal png size 12*60,720
set output "recovery/plots/airtemp_1_m60.png"
...
plot\
	...
	'recovery/values/60/cdrec60_k2.txt' index 0 using 1:2 title 'cdrec\_k2' with linespoints lt 8 lw 3 pt 7 lc rgbcolor "blue" pointsize 1.2, \
