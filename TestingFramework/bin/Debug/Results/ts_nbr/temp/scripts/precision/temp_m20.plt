...
set output "recovery/plots/temp_m20.png"
...
plot\
	...
	'recovery/values/20/spirit20.txt' index 0 using 1:2 title 'spirit' with linespoints lt 8 dt 6 lw 3 pt 6 lc rgbcolor "dark-green" pointsize 2, \
