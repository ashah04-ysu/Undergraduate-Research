...
set output "recovery/plots/temp_m50.png"
...
plot\
	...
	'recovery/values/50/spirit50.txt' index 0 using 1:2 title 'spirit' with linespoints lt 8 dt 6 lw 3 pt 6 lc rgbcolor "dark-green" pointsize 2, \
